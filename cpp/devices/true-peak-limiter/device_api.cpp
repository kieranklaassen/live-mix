// Flat C ABI (cpp/common/device_api.h) over the true-peak limiter for the
...
namespace {
livemix::TruePeakLimiterDevice g_device;
}
...
void device_set_param(int param_id, float value) {
  g_device.set_param(static_cast<livemix::TruePeakLimiterParam>(param_id), value);
}
...
int device_max_block_frames(void) { return livemix::TruePeakLimiterDevice::kMaxBlockFrames; }
