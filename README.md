...
| Reference                                                                      | [score](./docs/score.md) · [agent API](./docs/agent-api.md) · [agent-authored scores](./docs/agent-authored-scores.md) · [session grid](./docs/session.md) · [control surface](./docs/control-surface.md) · [devices](./docs/devices.md) · [Faust](./docs/faust-devices.md) · [WAM](./docs/wam.md) · [iPhone checklist](./docs/iphone-memory-and-element-source.md) |
...
| U25  | React UI kit                                                                       | done ([#36](https://github.com/kieranklaassen/live-mix/pull/36)); ambient-live `components/daw` deletion is the follow-up                                                                                                              |
...
| U30  | Controller arbitration, version history                                            | not started                                                                                                                                                                                                                            |
| U31  | Session grid and follow actions                                                    | done ([#41](https://github.com/kieranklaassen/live-mix/pull/41)); the kit's `GridView` is the follow-up (the playground mounts its own over `useSession`)                                                                              |
| U32  | Warping: TempoMap, StretchSource, Camelot                                          | done ([#24](https://github.com/kieranklaassen/live-mix/pull/24)); a scheduler-driven `StretchTrack` when a consumer pulls warped clips                                                                                                 |
...
| U38  | Agent-authored scores (planner → score → render/live)                              | not started                                                                                                                                                                                                                            |
| U39  | Native shell (optional per consumer)                                               | not started; only on Kieran's explicit pull                                                                                                                                                                                            |
| U40  | Playground and documentation                                                       | this PR                                                                                                                                                                                                                                |
